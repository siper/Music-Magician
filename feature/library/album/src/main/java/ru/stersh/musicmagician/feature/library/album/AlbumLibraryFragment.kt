...
class AlbumLibraryFragment : LibraryFragment() {
    ...
    private val presenter by moxyPresenter {
        ru.stersh.musicmagician.feature.library.album.AlbumLibraryPresenter(Di.get(), Di.get())
    }
    ...
    override val adapter = ru.stersh.musicmagician.feature.library.album.AlbumLibraryAdapter {
        router.navigateTo(Screens.albumEditor(it))
    }
