...
abstract class LibraryFragment : MvpAppCompatFragment(), SearchView.OnQueryTextListener, LibraryView {
    protected var menu: Menu? = null
    open val title: String by lazy { getString(R.string.app_name) }
    open val menuLayout: Int = -1

    abstract val adapter: AsyncListDifferDelegationAdapter<MediastoreItem>
    ...
    override fun showContent(items: List<MediastoreItem>) {
        adapter.items = items
