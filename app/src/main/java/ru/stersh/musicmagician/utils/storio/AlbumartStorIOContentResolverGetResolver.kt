...
class AlbumartStorIOContentResolverGetResolver : DefaultGetResolver<ru.stersh.musicmagician.data.core.entity.Albumart>() {

    override fun mapFromCursor(storIOContentResolver: StorIOContentResolver,
                               cursor: Cursor): ru.stersh.musicmagician.data.core.entity.Albumart {
