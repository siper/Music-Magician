...
class TrackSearchInteractor(
    ...
    private fun deezer(title: String, artist: String): Single<List<ru.stersh.musicmagician.data.server.core.entity.TrackTag>> {
        return deezerTrackTagRepository
                .getTags(title, artist)
                .onErrorReturn { emptyList() }
    }

    private fun itunes(title: String, artist: String): Single<List<ru.stersh.musicmagician.data.server.core.entity.TrackTag>> {
        return itunesTrackTagRepository
                .getTags(title, artist)
                .onErrorReturn { emptyList() }
    }

    private fun chartlyrics(title: String, artist: String): Single<List<ru.stersh.musicmagician.data.server.core.entity.LyricsTag>> {
    ...
    private fun cajunlyrics(title: String, artist: String): Single<List<ru.stersh.musicmagician.data.server.core.entity.LyricsTag>> {
        return cajunlyricsRepository
                .getTags(title, artist)
                .onErrorReturn { emptyList() }
    }

    private fun lololyrics(title: String, artist: String): Single<List<ru.stersh.musicmagician.data.server.core.entity.LyricsTag>> {
